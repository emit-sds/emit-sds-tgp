...
from windspeed import windspeed_key_names
...
def compute_Q_and_Qunc_simple_IME(
    ...
    wsk = windspeed_key_names(primary_windspeed_source, secondary_windspeed_source, BASE, UNITS)
    windspeed_primary_key       = wsk['primary']
    windspeed_secondary_key     = wsk['secondary']
    windspeed_std_primary_key   = wsk['primary_std']
    windspeed_std_secondary_key = wsk['secondary_std']
    windspeed_key               = wsk['combined']
    windspeed_std_key           = wsk['combined_std']
